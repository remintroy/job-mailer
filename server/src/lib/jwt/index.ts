...
export default class GetJwt {
  ...
  constructor(data: ConstructorInput) {
    ...
    if (!data.accessTokenSecret) console.warn("Access token secret is not provided");
    if (!data.refreshTokenSecret) console.warn("Refresh token secret is not provided");
    if (!data.accessTokenOptions) console.warn("Access token options is not provided");
    if (!data.refreshTokenOptions) console.warn("Refresh token options is not provided");
  }
